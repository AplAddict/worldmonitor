...
export const MISSION_PRESETS: readonly MissionPreset[] = [
  ...
  },
  {
    ...
    label: 'Stock Geek',
    shortLabel: 'Stocks',
    description: 'Decision-first equity desk: market regime, earnings risk, sector breadth, catalysts, options positioning, and geopolitical transmission — not a generic crypto dashboard.',
    icon: '$',
    view: 'america',
    zoom: 3,
    timeRange: '24h',
